...
#reader(lib "htdp-intermediate-reader.ss" "lang")((modname step_04) (read-case-sensitive #t) (teachpacks ()) (htdp-settings #(#t constructor repeating-decimal #f #t none #f () #t)))
...
(define B1 (make-ball (/ WIDTH 2) (/ HEIGHT 2) 4 -3))    ; middle ball
(define B2 (make-ball (+ LEF 1) (- BOT 1) 2  -4))        ; left bot ball
; ...
